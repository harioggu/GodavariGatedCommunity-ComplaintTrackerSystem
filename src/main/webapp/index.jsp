...
<body>
  <main class="wrap">
    ...
    <div class="field">
        <input id="password" name="password" type="password" placeholder="Enter the password" autocomplete="current-password">
        <button type="button" class="toggle" id="show">Show</button>
    </div>

    <div class="foot">
        Don't have an account? <a href="signup.jsp"><b>Signup</b></a>
    </div>
